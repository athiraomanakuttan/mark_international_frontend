...
import type { FollowupData, LeadResponse } from "@/types/lead-type"
...
export function LeadHistoryModal({ leadId, open, onOpenChange }: LeadHistoryModalProps) {
...
>
        ...
        <DialogHeader>
          <DialogTitle className="sr-only">Lead History Details</DialogTitle>
        </DialogHeader>
